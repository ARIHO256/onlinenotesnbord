...
![Screenshot 1](https://github.com/Ravi879/NoticeBoard/raw/master/Screenshot/register.jpg "")
 ...
 #### Project directories
1. `backend/`: Django + DRF with JWT auth (`users`, `notices` apps)
2. `mobile/`: React Native (Expo) app
...
- GET `/api/users/profiles/faculty/`, `/api/users/profiles/students/`
- CRUD `/api/notices/`
...
cd mobile
npm install
# Optional: set EXPO_PUBLIC_API_URL (default http://10.0.2.2:8000)
npm run start
```
